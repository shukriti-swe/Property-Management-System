     ...
     <div class="container-fluid">
         ...
         <div class="row">
             <div class="col-12">
                 <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                     <h4 class="mb-sm-0"><?php echo lang('Floor.floor_add'); ?> </h4>

                     <div class="page-title-right">
                         <ol class="breadcrumb m-0">
                             <li class="breadcrumb-item"><a href="javascript: void(0);"><?php echo lang('Floor.golden_tower'); ?></a></li>
                             <li class="breadcrumb-item active"><?php echo lang('Floor.floor_add'); ?></li>
                         </ol>
                     </div>
         ...
         <div class="row">
             <div class="col-lg-12">
                 <div class="card">
                     <div class="card-body ">
                         <h4 class="card-title mb-4"><?php echo lang('Floor.floor_add'); ?></h4>

                         <form action="<?php echo base_url() ?>/admin/floor_add" method="post" class="needs-validation" novalidate>
                             <div class="mb-4">
                             ...
                             <div class="d-flex mt-4">
                                 ...
                                 href="<?php echo base_url() ?>/admin/floor_list"><?php echo lang('Floor.cancel'); ?></a>
