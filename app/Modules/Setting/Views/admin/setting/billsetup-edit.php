                ...
                <div class="col-lg-12"> 
                    <div class="card">
                        <div class="card-body ">
                            ...
                            <form action="<?php echo base_url() ?>/admin/billsetup_edit/<?= $billSetupEdit['id']; ?>" method="post" class="needs-validation" novalidate>
                                <div class="row">
                                    <div class="col-md-12 mt-4">
                                        <label><?php echo lang('setting/Bill_setup.billset_head'); ?></label>
                                        <input type="text" class="form-control" name="bill_type"
                                        value="<?= $billSetupEdit['billtype']; ?>" required>
                                ...
                                <div class="d-flex mt-4">
                                    <a class="btn btn-outline-danger btn-rounded" href="<?php echo base_url() ?>/admin/billsetup_add"><?php echo lang('setting/Bill_setup.cancel'); ?></a>
                                    <button type="submit" class="btn btn-primary ms-auto btn-rounded"><?php echo lang('setting/Bill_setup.update'); ?></button>
                                </div>
                            </form>
