                        ...
                        <?= $getCommitte['id']; ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <textarea class="form-control" name="m_presentads" required>
                                        <?= $getCommitte['mpresentads']; ?>
                                    </textarea>
                                    <div class="valid-feedback">Looks good!</div>
                                    <small style="color:red;" class="text-danger"><?php if (isset($validation)) {
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <textarea class="form-control" name="m_permanentads" required>
                                        <?= $getCommitte['mpermanentads']; ?>
                                    </textarea>
                                    <div class="valid-feedback">Looks good!</div>
                                    <small style="color:red;" class="text-danger"><?php if (isset($validation)) {
