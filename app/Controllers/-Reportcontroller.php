...
class Reportcontroller extends BaseController
{
    ...
    public function rent_report()
    {
        ...
        $data['floors'] = $floors;
        return view('admin/report/rent/rent_report', $data);
    }
    public function rent_info()
    {
        ...
        if (empty($unit_name) && empty($floor_name) && empty($year) && empty($status)) {
            ...
            return view('admin/report/rent/rent_info_report', $data);
        }
    }
    public function print_rent_report()
    {
        ...
        return view('admin/report/rent/print_rent_report', $data);
    }
    ...
    public function fund_status()
    {
        ...
        return view('admin/report/fund/fund_status', $data);
    }
    ...
    public function print_fund_status()
    {
        ...
        $data['maintenences'] = $maintenences;
        // $print_salary_details= $session->has('salary_details');
        return view('admin/report/fund/print_fund_status', $data);
    }
    ...
    public function bill_report()
    {
        ...
        return view('admin/report/bill_deposit/bill_report', $data);
    }
    ...
    public function bill_info()
    {
        ...
        if (empty($date) && empty($month) && empty($year)) {
            ...
            $data['bills'] = $bills;
            return view('admin/report/bill_deposit/bill_info', $data);
        }
    }
    ...
    public function print_bill_report()
    {
        ...
        $data['bills'] = $bills;
        // $print_salary_details= $session->has('salary_details');
        return view('admin/report/bill_deposit/print_bill_report', $data);
    }
    ...
    public function salary_report()
    {
        ...
        return view('admin/report/salary/salary_report', $data);
    }
    public function salary_info()
    {
        ...
        if (empty($employee_id) && empty($month) && empty($year)) {
            ...
            $data['employees'] = $employees;
            return view('admin/report/salary/employee_salary_info', $data);
        }
    }
    public function print_salary_report()
    {
        ...
        return view('admin/report/salary/print_salary_report', $data);
    }
    ...
    public function rentedReport()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            if (!$this->validate('tenantReportValidate')) {
                ...
                return view('admin/report/tenant/rented-info', $data);
            }
        }

        return view('admin/report/tenant/rented-report',$data);
    }
    public function rentedPrintReport()
    {
        ...
        return view('admin/report/tenant/rentedprint-info', $data);
    }
    ...
    public function visitorReport()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if ($date == '' && $month == '' && $year == '') {
                ...
                if ($date != '') {
                    ...
                    return view('admin/report/visitor/visitor-info', $data);
                } else {
                    if ($month == '' || $year == '') {
        ...
        return view('admin/report/visitor/visitor-report', $data);
    }
    ...
    public function visitorPrintReport()
    {
        ...
        return view('admin/report/visitor/visitorprint-info', $data);
    ...
    public function complainReport()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if ($date == '' && $month == '' && $year == '') {
                ...
                if ($date != '') {
                    ...
                    return view('admin/report/complain/complain-info', $data);
                } else {
                    if ($month == '' || $year == '') {
                        $data['error'] = '<div class="alert alert-danger text-center">Please Select Month And Year Field!</div>';
                    } else {
        ...
        return view('admin/report/complain/complain-report', $data);
    }
    ...
    public function complainPrintReport()
    {
        ...
        return view('admin/report/complain/complainprint-info', $data);
    }
    ...
    public function unitReport()
    {
        ...
        if ($this->request->getMethod() == 'post') {
                ...
                if (!$this->validate('unitReportValidate')) {
                    ...
                    return view('admin/report/unit/unit-info', $data);
                    
                }
           
        }

        return view('admin/report/unit/unit-report', $data);
    }
    ...
    public function unitPrintReport()
    {
        ...
        return view('admin/report/unit/unitprint-info', $data);
    }
...
/*===============================================================
 ...
 public function rentInfoPdf()
 {
     ...
     $html = view('admin/report/rent/pdf_rent_report', $data);
 ...
 public function rentedPdf()
 {
     ...
     $html = view('admin/report/tenant/rented_pdf', $data);
 ...
 public function visitorPdf()
 {
     ...
     $html = view('admin/report/visitor/visitor-pdf', $data);
 ...
 {
     $data['getComplains'] = $this->session->get('getComplains');
     $html = view('admin/report/complain/complain-pdf', $data);
 ...
 {
     $data['getUnits'] = $this->session->get('getUnits');
     $html = view('admin/report/unit/unit-pdf', $data);
 ...
 public function fundStatusPdf()
 {
     ...
     $html = view('admin/report/fund/fund_pdf', $data);
 ...
 public function billInfoPdf()
 {
     ...
     $html = view('admin/report/bill_deposit/bill_pdf', $data);
 ...
 public function salaryInfoPdf()
 {
     ...
     $html = view('admin/report/salary/salary_pdf', $data);
