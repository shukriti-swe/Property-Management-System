            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-4 text-end">
                        <a href="<?= base_url('admin/ownerutilityadd')?>" class="btn btn-primary btn-rounded waves-effect waves-light"><i class=" ri-menu-add-line me-1"></i><?php echo lang('admin/owner_utility.a_o_u'); ?></a>
                    </div>
                    <div class="card">
                        <div class="card-body ">
