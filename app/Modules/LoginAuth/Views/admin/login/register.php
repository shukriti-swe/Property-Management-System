...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Register | RS Property</title>
            ...
            <div class="container">
                    ...
                    <div class="col-xl-5 col-lg-6 col-md-8">
                        <div class="card">
                            ...
                            <div class="text-center mb-4">
                                ...
                                <p class="text-muted text-center mb-4">Get your free <b>RS Property</b> account now.</p>
                                <?php 
             ...
             echo $validation->getError('term_and_condition'); }} ?></p>
                        ...
                        <div class="mt-5 text-center">
                            <p class="text-white-50">Already have account ?<a href="<?=base_url();?>" class="fw-medium text-primary"> Login </a> </p>
                            <p class="text-white-50">© <script>document.write(new Date().getFullYear())</script> Property Management. Crafted with <i class="mdi mdi-heart text-danger"></i> by <b>RS Software</b></p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
