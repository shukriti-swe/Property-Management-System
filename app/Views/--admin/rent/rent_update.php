            ...
            <div class="col-lg-12">
                        ...
                        <form action="<?= base_url('admin/rentupdate/'.$rent->id)?>" method="POST"enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <p style="color:red;" class="text-danger"><?php if(isset($validation)){ if($validation->hasError('floor_name')) {
             echo $validation->getError('floor_name'); }} ?></p>
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <select name="month" id="ddlMonth" class="form-control">
                                        ...
                                        foreach($months as $month){?>
                                            <option value="<?=$month['monthname'];?>"<?php if($rent->month==$month['monthname']){echo "selected";}?>><?=$month['monthname'];?></option>
                                       <?php  }
                                        ?>
             ...
             echo $validation->getError('month'); }} ?></p>
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <select name="year" id="ddlYear" class="form-control">
                                        ...
                                        <option value="<?=$year['year'];?>"<?php if($rent->year==$year['year']){echo "selected";}?>><?=$year['year'];?></option>
                                        <?php  }
                                        ?>
             ...
             echo $validation->getError('year'); }} ?></p>
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <p style="color:red;" class="text-danger"><?php if(isset($validation)){ if($validation->hasError('renter_name')) {
             echo $validation->getError('renter_name'); }} ?></p>
                                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <p style="color:red;" class="text-danger"><?php if(isset($validation)){ if($validation->hasError('rent')) {
             echo $validation->getError('rent'); }} ?></p>
                                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <p style="color:red;" class="text-danger"><?php if(isset($validation)){ if($validation->hasError('total_rent')) {
             echo $validation->getError('total_rent'); }} ?></p>
                                                        <div class="invalid-feedback">
             ...
             echo $validation->getError('issue_date'); }} ?></p>
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <p style="color:red;" class="text-danger"><?php if(isset($validation)){ if($validation->hasError('bill_paid_date')) {
             echo $validation->getError('bill_paid_date'); }} ?></p>
                                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <select name="bill_status" id="ddlBillStatus" class="form-control">
                                        <option value="0" <?php if($rent->bill_status==0){echo "selected";}?>>Due</option>
                                        <option value="1" <?php if($rent->other_bill==1){echo "selected";}?>>Paid</option>
                                    </select>
                                    <p style="color:red;" class="text-danger"><?php if(isset($validation)){ if($validation->hasError('bill_status')) {
             echo $validation->getError('bill_status'); }} ?></p>
                                                        <div class="invalid-feedback">
                            ...
                            <div class="d-flex mt-4">
                                <button class="btn btn-outline-danger btn-rounded " onclick="window.history.back();"><?php echo lang('admin/rent.cancel'); ?></button>
                                <button type="submit" name="btnSavePrint" class="btn btn-light btn-rounded mx-2"><i class="fa fa-floppy-o"></i> <?php echo lang('admin/rent.s_a_p_i'); ?></button>
