                ...
                <div class="col-lg-12"> 
                    <div class="card">
                        <div class="card-body ">
                            ...
                            <form action="<?php echo base_url() ?>/admin/complain_edit/<?= $getComplain['id']; ?>" method="post" class="needs-validation" novalidate>
                                <div class="row">
                                    <div class="col-md-12 mt-4">
                                        <label><?php echo lang('Complain.com_title'); ?></label>
                                        <input type="text" class="form-control" name="com_title"
                                        value="<?= $getComplain['comtitle']; ?>" required>
                                    ...
                                    <div class="col-md-12 mt-4">
                                        ...
                                        <textarea class="form-control" name="com_description" required><?= $getComplain['comdescription']; ?></textarea>
                                        <div class="valid-feedback">Looks good!</div>
                                        <small style="color:red;" class="text-danger"><?php if (isset($validation)) {
                                    ...
                                    <div class="col-md-12 mt-4">
                                        ...
                                        value="<?= $getComplain['comdate']; ?>" required>
                                        <div class="valid-feedback">Looks good!</div>
                                        <small style="color:red;" class="text-danger"><?php if (isset($validation)) {
                                ...
                                <div class="d-flex mt-4">
                                    ...
                                    <button type="submit" class="btn btn-primary ms-auto btn-rounded"><?php echo lang('Complain.update'); ?></button>
                                </div>
                            </form>
