                    ...
                    <div class="card-body ">
                        ...
                        <form action="" id="mailsmsAdd">
                            ...
                            <div class="mt-4">
                                ...
                                <input type="text" class="form-control" placeholder="Message Title" name="mail_sub" id="mailSub" value="">
                                <span id="mailSubErr"></span>
                            </div>
                            <div class="mt-4">
                                <label>Message *</label>
                                <textarea class="form-control" placeholder="Message" name="mail_mess" id="mailMess"></textarea>
                            ...
                            <!-- Tab panes -->
                            <div class="tab-content ps-0 p-1">
                                ...
                                <div class="tab-pane" id="menu1" role="tabpanel">
                                    ...
                                    <select class="tenant_select" name="tenant_name[]" multiple="multiple">
                                        <?php foreach($getTenants as $tenants) : ?>
                                            <option value="<?= $tenants['id']; ?>"><?= $tenants['tename']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 pt-5">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="now" class="col-5"> &nbsp;NOW&nbsp;&nbsp;</label>
                                            <div class="col-7">
                                        ...
                                        <div class="checkbox mb-3 row">
                                            <label for="futureDate" class="col-5">&nbsp;Future Date : </label>
                                            <div class="col-7">
                                                <input type="checkbox" class="fCheck">
                                                <input type="text" id="futureDate" class="seheduletype form-control ftext"
                                                name="future_date">
                                            </div>
                                        </div>
                            ...
                            <div class="d-flex mt-4">
                                ...
                                <button type="button" id="submit" class="btn btn-primary ms-auto btn-rounded">Save</button>
                            </div>
                        </form>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", "#submit", function() {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>/admin/mailsms_add",
                type: "post",
                data: allData,
                dataType: "JSON",
                success: function(data) {
                    if (data.error != '') {
                        ...
                        window.location.href = "<?php echo base_url(); ?>/admin/mailsms_list";
                    }
                }
            });
