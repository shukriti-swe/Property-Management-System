                        ...
                        <form action="<?php echo base_url() ?>/admin/tenant_edit/<?= $getTenant['id']; ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-4">
                                    ...
                                    <textarea name="te_ads" class="form-control" required>
                                        <?= $getTenant['teads']; ?>
                                    </textarea>
                                    <div class="valid-feedback">Looks good!</div>
                                    <small style="color:red;" class="text-danger"><?php if (isset($validation)) {
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <input type="text" class="form-control" name="te_nid" value="<?= $getTenant['tenid']; ?>" required>
                                    <div class="valid-feedback">Looks good!</div>
                                    <small style="color:red;" class="text-danger"><?php if (isset($validation)) {
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <select name="floor_no" id="floorId" class="form-control">
                                        ...
                                        <?php foreach ($getFloors as $floors) : ?>
                                            <option value="<?= $floors['id']; ?>" <?php echo ($floors['floorno'] == $getTenant['floorno'] ? "Selected" : " "); ?>><?= $floors['floorno']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="col-md-6 mt-4">
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="te_advancerent" class="form-control" value="<?= $getTenant['teadvancerent']; ?>">
