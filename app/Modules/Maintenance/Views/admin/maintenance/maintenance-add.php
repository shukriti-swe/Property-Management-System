            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body ">
                        ...
                        <form action="<?php echo base_url() ?>/admin/maintenance_add" method="post" class="needs-validation" novalidate>
                            <div class="row">
                            ...
                            <div class="d-flex mt-4">
                                ...
                                <button type="submit" class="btn btn-primary ms-auto btn-rounded"> <?php echo lang('Maintenance.created'); ?></button>
                            </div>
                        </form>
