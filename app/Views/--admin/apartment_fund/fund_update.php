            ...
            <div class="row">
                                        ...
                                        <label>* <?php echo lang('admin/apartment_fund.owner_n'); ?></label>
                                         ...
                                         <option value="">--Select Owner--</option>
                                             ...
                                             foreach($get_owners as $owner){?>
                                                ...
                                                <option value="<?= $owner['name'].','.$owner['owner_id'].','.$owner['image'];?>"
                                                <?php
             ...
             echo $validation->getError('owner_name'); }} ?></p>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        ...
                                        foreach($months as $month){?>
                                            <option value="<?=$month['monthname'];?>"<?php if($get_fund['month']==$month['monthname']){echo "selected";}?>><?=$month['monthname'];?></option>
                                       <?php  }
                                        ?>
                                          </select>
             ...
             echo $validation->getError('month'); }} ?></p>
                                    ...
                                    <div class="col-md-6 mt-4">
                                        ...
                                        <option value="<?=$year['year'];?>"<?php if($get_fund['year']==$year['year']){echo "selected";}?>
                                        ><?=$year['year'];?></option>
                                        <?php  }
                                        ?>
